package com.logisticscraft.logisticsapi.excluded.liquid;
...
public class FluidManager {
    ...
    public static Location getContainerLocation(@NonNull final FluidContainer fluidContainer) {
        for (Map.Entry<Location, FluidContainer> entry : fluidContainers.entrySet())
            if (entry.getValue()
